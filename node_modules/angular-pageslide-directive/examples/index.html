        ...
        <div id="main_content_wrap" class="outer" style="padding:20px">
            ...
            <section id="main_content" class="inner">
                ...
                <div ng-controller="pageslideCtrl">
                    ...
                    <p>Check to open: <input type="checkbox" ng-model="checked" ></p>
                    <pageslide ps-push='true' ps-open="checked" ps-container='container1' >
                        <div style="padding:20px">
                            <h2>Yo Pageslide</h2>
                            <p>meh</p>
                        </div>
                ...
                <div ng-controller="pageslideCtrl">
                    <h3>In a container with directions</h3>
                    <p>Check to open: <input type="checkbox" ng-model="checked" ></p>
                    <pageslide ps-side='bottom' ps-open="checked" ps-container='container2' >
                        <div style="padding:20px">
                            <h2>Yo Pageslide</h2>
                            <p>meh</p>
                        </div>
